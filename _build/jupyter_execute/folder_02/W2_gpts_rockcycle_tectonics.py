...
## Earth’s Structure
Earth has three major compositional layers the crust, mantle, and core (Shown in Figures 3 and 4). These layers are a consequence of the heat that was produced during the accretion of Earth from the early solar disk. Gravitational compaction, decay of radioactive elements, and bombardment by meteorites heated the proto-earth enough to melt the initially random mixture of solar system dust and gases. After melting, the constituent parts were able to stratify by composition. The denser metals (mainly iron and nickel) sank to the interior forming the core while the lighter elements (oxygen, silicon, magnesium, etc.) rose to the top forming the crust and mantle, in a process called differentiation. Earth’s layers were discovered by their response to seismic waves, which is controlled by their physical properties. 
