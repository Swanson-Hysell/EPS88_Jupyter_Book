...
[Earth Science Literacy Principles: The Big Ideas and Supporting Concepts of Earth Science](http://www.earthscienceliteracy.org/)
A .pdf version and printer-friendly .docx version can be downloaded from bCourses.
...
![The history of Earth compressed into a year](./figures/earth_history_in_a_year.png)
...
The core is the dense, metal deep-interior of Earth, made up of two physical layers the inner-core and outer-core. The inner-core is a solid iron and nickel alloy, and \~1200 km in radius. The inner-core boundary (ICB) is the surface at which the temperature and pressure conditions within the earth allow this iron and nickel alloy to freeze. The outer-core a \~2300 km thick layer of molten iron and nickel alloy with a kinematic viscosity similar to water (\~1x10<sup>-6</sup> m<sup>2</sup>/s). Because the outer-core is liquid seismic shear waves (S-waves) cannot travel through it; a shadow zone is observed where seismographs located greater than \~105° from an earthquake will not record its S-waves. The core – mantle boundary (CMB) is defined by a large discontinuity between the denser, liquid, metal outer-core and the less dense, plastic-solid, rocky mantle. 
...
![Structure of Earth](./figures/earth_structure.png)
...
![Examples of igneous rocks](./figures/usgs_igneous.png)

>Figure 5: Examples of intrusive (granite) and extrusive igneous rocks (basalt). Source: modified from [USGS](https://pubs.usgs.gov/bul/2195/b2195.pdf)
...
![Examples of a sedimentary rock](./figures/usgs_sandstone.png)

>Figure 6: Example of a sedimentary rock, sandstone. Source: modified from [USGS](https://pubs.usgs.gov/bul/2195/b2195.pdf)
...
![Examples of metamorphic rocks](./figures/gneiss.png)

>Figure 7: Examples of a metamorphic rock and the rock that it formed from.
 

![Examples of a sedimentary](./figures/usgs_rock_cycle.png)

>Figure 8: The rock cycle. Source: modified from [USGS](https://pubs.usgs.gov/bul/2195/b2195.pdf)
...
![Plate boundaries](./figures/subduction_zone_profile.png)
